...
struct ContentView: View {
    ...
    init() {
        ...
        let GARAGE4 = MKMapItem(placemark: MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 35.215678, longitude: -97.435678)))
        GARAGE2.name = "Garage 2"
        
        let GARAGE5 = MKMapItem(placemark: MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 35.218901, longitude: -97.440901)))
        GARAGE3.name = "Garage 3"
        
        let GARAGE6 = MKMapItem(placemark: MKPlacemark(coordinate: CLLocationCoordinate2D(latitude: 35.222234, longitude: -97.446234)))
        GARAGE4.name = "Garage 4"

       _garages = State(initialValue: [ASP, ELM, JENKINS, GARAGE4, GARAGE5, GARAGE6])
   }
